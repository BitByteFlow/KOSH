...
export class ProductResolver {
	...
	async listProductsWithFilter(
		...
		return await this.productService.listProductsWithFilters(storeId, filterInput);
	}
	...
	async createProduct(
		...
		return await this.productService.createProduct(user.id, storeId, createProductDto);
	}
