...
export class ValidationError extends ApplicationError {
  constructor(
    ...
    super(message, {
      ...
      cause: options?.cause,
      sendToSentry: true, // Send but as warning
...
export class InvalidFormatError extends ValidationError {
  constructor(fieldName: string, expectedFormat: string) {
    super(`The field '${fieldName}' has an invalid format. Expected: ${expectedFormat}`, {
      field: fieldName,
  ...
  constructor(
    ...
    super(message, {
      ...
      context: options
        ...
        : undefined,
      cause: options?.cause,
      sendToSentry: true, // Send but as info
...
export class InsufficientFundsError extends BusinessLogicError {
  constructor(required: number, available: number, currency = "USD") {
    super(`Insufficient funds. Required: ${currency} ${required}, Available: ${currency} ${available}`, {
...
export class DatabaseError extends ApplicationError {
  constructor(
    ...
    super(message, {
      ...
      context: options?.context,
      cause: options?.cause,
      sendToSentry: true, // Send as error
