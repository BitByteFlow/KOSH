...
const validateStoreId = async (
	...
	try {
		...
		return {
			valid: false,
			error: "Store not found. Please check the ID and try again.",
		};
	} catch {
		return {
			valid: false,
						...
						<div className="flex items-start justify-between mb-8">
							<div>
								...
								<p className="text-slate-500 text-sm font-medium mt-1">
									...
									! Enter your Store ID to get started.
								</p>
							</div>
							<Button
								type="button"
							...
							>
								<div className="space-y-2">
									...
									<p className="text-xs text-slate-400 leading-relaxed">
										Ask your store administrator for the Store ID. It is a
										unique identifier found in the store settings.
									</p>
								</div>
								<Button
									type="submit"
								...
								<div className="flex flex-col items-center py-4 gap-3">
									...
									<div className="text-center">
										...
										<p className="text-slate-500 text-sm mt-1">
											You're request has been sent for approval
										</p>
									</div>
								</div>
							</div>
