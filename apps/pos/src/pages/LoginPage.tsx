  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-slate-100/40 rounded-full blur-3xl" />
      </div>
      ...
      >
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
          ...
          <div className="p-10 flex flex-col items-center">
            ...
            >
              <span className="text-3xl font-black text-white leading-none">K</span>
            </motion.div>

            <h1 className="text-2xl font-black text-slate-900 tracking-tight">KOSH POS</h1>
            ...
            <AnimatePresence mode="wait">
              {isLoading ? (
                ...
                >
                  ...
                  <p className="text-sm font-bold text-slate-500 uppercase tracking-widest">Signing in...</p>
                </motion.div>
              ) : (
                <motion.div
                  key="button"
                ...
                >
                  ...
                  {!GOOGLE_CLIENT_ID && (
                    <p className="text-xs text-amber-600 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 text-center">
                      ⚠️ Set <code className="font-mono">VITE_GOOGLE_CLIENT_ID</code> in your <code className="font-mono">.env</code> to enable Google Sign-In.
                    </p>
                  )}
                </motion.div>
              )}
            ...
            <p className="text-xs text-slate-400 mt-8 text-center leading-relaxed max-w-[260px]">
              By signing in, you agree to our Terms of Service. Your session is secured end-to-end.
            </p>
          </div>
        </div>
