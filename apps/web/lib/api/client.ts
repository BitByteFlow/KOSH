 ...
 * Use this in Client Components with React Query
 * Requires token to be passed explicitly (from client-side session)
 */
...
/**
 * Server-side API client (for Server Components, Server Actions, API Routes)
 */
