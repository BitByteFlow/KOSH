...
const use_mobile_1 = require("@kosh/ui/hooks/use-mobile");
const utils_1 = require("@kosh/ui/lib/utils");
const button_1 = require("@kosh/ui/components/button");
const input_1 = require("@kosh/ui/components/input");
const separator_1 = require("@kosh/ui/components/separator");
const sheet_1 = require("@kosh/ui/components/sheet");
const skeleton_1 = require("@kosh/ui/components/skeleton");
const tooltip_1 = require("@kosh/ui/components/tooltip");
...
function SidebarTrigger({ className, onClick, ...props }) {
    ...
    return (<button_1.Button data-sidebar="trigger" data-slot="sidebar-trigger" variant="ghost" size="icon" className={(0, utils_1.cn)("size-7", className)} onClick={(event) => {
			...
			<lucide_react_1.PanelLeftIcon className="data-[state=collapsed]:rotate-180"/>
		</button_1.Button>);
}
...
function SidebarGroupLabel({ className, asChild = false, ...props }) {
    ...
    return (<Comp data-slot="sidebar-group-label" data-sidebar="group-label" className={(0, utils_1.cn)("text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[opacity,height] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0", "group-data-[collapsible=icon]:h-0 group-data-[collapsible=icon]:opacity-0 group-data-[collapsible=icon]:overflow-hidden", className)} {...props}/>);
}
