...
import { generateRandomPaymentType, generateSaleItemData, generateRandomNumber, generateRandomString } from '../utils/dataGenerator.js';
...
export function createSaleTest() {
    ...
    const res = sendGraphQLRequest(GRAPHQL_URL, CREATE_SALE_MUTATION, variables, AUTH_TOKEN, STORE_ID);
