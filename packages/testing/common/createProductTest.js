...
export const AUTH_TOKEN = __ENV.TOKEN;
export const STORE_ID = __ENV.STORE_ID;
export const CATEGORY_ID = __ENV.CATEGORY_ID;
export const CATEGORY_NAME = __ENV.CATEGORY_NAME;
...
export function createProductTest() {
  ...
  const variants = [generateVariantData()];
